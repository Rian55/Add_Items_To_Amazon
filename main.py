...
# xdxd = types.get_definitions_product_type(productType="PERSONALBODYCARE", marketplaceIds=['A1PA6795UKMFR9'])
# print(xdxd)
...
sku_file = open("inv_de.txt", "r+", encoding="utf-8")
